...
class SimulatorEndToEndSmokeTests(unittest.TestCase):
    ...
    def test_full_flight_preset_streams_ownship_and_traffic_until_stop(self):
        ...
        self._post_json("/api/v1/simulation/traffic", {"enabled": True, "contact_count": 6})
        ...
        for aircraft_id in ("DDA857", "DDA85A", "DDA85C", "DDA86A", "DDA88F", "DDA896"):
            with self.subTest(aircraft_id=aircraft_id):
                self.assertIn(aircraft_id, flarm_payload)
