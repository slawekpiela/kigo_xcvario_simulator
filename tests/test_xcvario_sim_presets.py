...
class SimulatorPresetTests(unittest.TestCase):
    ...
    def test_glider_launch_preset_contains_expected_segment_sequence(self):
        ...
        self.assertAlmostEqual(preset.segments[1].target_speed_kmh, 100.0 / 150.0, places=6)
        self.assertEqual(preset.segments[120].segment_id, "launch_accel_120")
        self.assertAlmostEqual(preset.segments[120].target_speed_kmh, 80.0, places=6)
        ...
        self.assertAlmostEqual(preset.segments[-1].target_speed_kmh, 100.0, places=6)
