...
class SimulatorPanelAssetsTests(unittest.TestCase):
    ...
    def test_frontend_js_uses_state_endpoint_sse_and_control_commands(self):
        ...
        for snippet in (
            ...
            'storedToken && storedToken !== LEGACY_RUNTIME_TOKEN ? storedToken : DEFAULT_RUNTIME_TOKEN',
            'key === "piSimulatorHost" && storedValue === LEGACY_PI_SIMULATOR_HOST',
